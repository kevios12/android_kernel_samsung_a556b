...
enum {
	...
	PM_QOS_MFD_THROUGHPUT,
	PM_QOS_MFD_THROUGHPUT_MAX,
	PM_QOS_NPU0_THROUGHPUT,
	PM_QOS_NPU0_THROUGHPUT_MAX,
	PM_QOS_NPU1_THROUGHPUT,
	PM_QOS_NPU1_THROUGHPUT_MAX,
	PM_QOS_M2M_THROUGHPUT,
	PM_QOS_M2M_THROUGHPUT_MAX,
	PM_QOS_UNPU_THROUGHPUT,
	PM_QOS_UNPU_THROUGHPUT_MAX,
	PM_QOS_ICPU_THROUGHPUT,
	PM_QOS_ICPU_THROUGHPUT_MAX,
	/* insert new class ID */
...
#define PM_QOS_MFD_THROUGHPUT_DEFAULT_VALUE	0
#define PM_QOS_MFD_THROUGHPUT_MAX_DEFAULT_VALUE	INT_MAX
#define PM_QOS_NPU0_THROUGHPUT_DEFAULT_VALUE	0
#define PM_QOS_NPU0_THROUGHPUT_MAX_DEFAULT_VALUE	INT_MAX
#define PM_QOS_NPU1_THROUGHPUT_DEFAULT_VALUE	0
#define PM_QOS_NPU1_THROUGHPUT_MAX_DEFAULT_VALUE	INT_MAX
#define PM_QOS_M2M_THROUGHPUT_DEFAULT_VALUE	0
#define PM_QOS_M2M_THROUGHPUT_MAX_DEFAULT_VALUE	INT_MAX
#define PM_QOS_UNPU_THROUGHPUT_DEFAULT_VALUE	0
#define PM_QOS_UNPU_THROUGHPUT_MAX_DEFAULT_VALUE	INT_MAX
#define PM_QOS_ICPU_THROUGHPUT_DEFAULT_VALUE	0
#define PM_QOS_ICPU_THROUGHPUT_MAX_DEFAULT_VALUE	INT_MAX
...
#else
static inline int exynos_pm_qos_update_target(struct exynos_pm_qos_constraints *c, struct plist_node *node,
		enum exynos_pm_qos_req_action action, int value, bool nosync) { return 0; }
static inline void exynos_pm_qos_add_request_trace(char *func, unsigned int line,
		struct exynos_pm_qos_request *req, int exynos_pm_qos_class,
		s32 value) { }
static inline void exynos_pm_qos_update_request(struct exynos_pm_qos_request *req,
		s32 new_value) { }
static inline void exynos_pm_qos_update_request_nosync(struct exynos_pm_qos_request *req,
		s32 new_value) { }
static inline void exynos_pm_qos_update_request_timeout(struct exynos_pm_qos_request *req,
		s32 new_value, unsigned long timeout_us) { }
static inline void exynos_pm_qos_remove_request(struct exynos_pm_qos_request *req) { }

static inline int exynos_pm_qos_request(int exynos_pm_qos_class) { return 0; }
static inline int exynos_pm_qos_add_notifier(int exynos_pm_qos_class, struct notifier_block *notifier) { return 0; }
static inline int exynos_pm_qos_remove_notifier(int exynos_pm_qos_class, struct notifier_block *notifier) { return 0; }
static inline int exynos_pm_qos_request_active(struct exynos_pm_qos_request *req) { return 0; }
static inline s32 exynos_pm_qos_read_value(struct exynos_pm_qos_constraints *c) { return 0; }
static inline int exynos_pm_qos_read_req_value(int pm_qos_class, struct exynos_pm_qos_request *req) { return 0; }
static inline void show_exynos_pm_qos_data(int index) { }
#endif
